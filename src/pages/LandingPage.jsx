...
const LandingPage = () => {
    ...
    return (
        <section className='max-w-[375px] h-[100vh]  mx-auto px-5 py-10 flex flex-col items-start justify-end gap-[29px] bg-[var(--primary-bg-color)] text-[var(--primary-text-color)]'>
